...
(function($) {
    ...
    $.extend($.ui.textareainputsupport.prototype, {
        ...
        _create: function() {
            ...
            .attr({
                ...
                "aria-haspopup": "true"
            }).bind("keydown.autocomplete", self.keydownFunc(self)).bind("focus.autocomplete", function() {
            ...
            }).menu(this.menuOpt(self, doc)).zIndex(this.element.zIndex() + 1)
    ...
    function selectHeadMatch(array, term) {
        ...
        return $.grep(array, function(val, i) {
